...
class DAQ_1DViewer_NIDAQmx(DAQ_Viewer_base):
    """
    Plugin for a 1D data visualization & acquisition with various NI modules plugged in a NI cDAQ.
    """
    channels_ai: str
    ...
    def ini_detector(self, controller=None):
        ...
        """
        logger.info("Detector 1D initialized")
    ...
    def grab_data(self, Naverage=1, **kwargs):
        ...
        """
        data_from_task = self.controller._task.read(100)
